...
const availableActions = {
    ...
    "Applications": [
        ...
        { id: 'web', name: 'Open Website', disabled: true },
    ],
    "Window": [
        { id: 'maximize', name: "Maximize Active Window", disabled: false },
        { id: 'close', name: "Close Active Window", disabled: false },
    ],
    "System": [
...
function ServerUI() {
    ...
    const updateConfiguration = (targetIndex: number, newConfig: TileConfig) => {
        if (targetIndex > -1) {
            const newTiles = [...tiles]
